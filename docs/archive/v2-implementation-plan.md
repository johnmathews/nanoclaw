...
>
> **What's left, all deferred:** W4.6 remote-control (nice-to-have), W4.2 status-tracker (no non-native-typing channel needs it), W5.1 Slack `getThreadMessages`/migration v6 (no caller), W5.3 Gmail channel (no live use case), §20 `skipImageMultimodal` host wiring (no consumer). Plus one calendar-pending verification: §18's first cron live-fire on Mon 2026-05-25 02:03 CEST. Full closure record + deferred-items table in [p3-notes.md §22](p3-notes.md); per-file disposition in [fork-local-inventory.md](fork-local-inventory.md). New work should NOT extend this document — it lives in PRs, `journal/`, or new top-level docs.

**See also:** [motivation-and-context.md](motivation-and-context.md) for why, what decisions were made, and what alternatives were rejected. [spike-notes.md](spike-notes.md) captures the P1 spike that inverted the credential-proxy approach. [p3-notes.md](p3-notes.md) §22 is the closure record.

<details>
<summary><strong>Historical status line (pre-closure)</strong></summary>

**Status:** active, **mid-migration**. **Last updated:** 2026-05-22 (post-W4.x-slack-interactivity). **Supersedes:** pre-P1 §2 line 3, §5 P1 (rewritten as historical record), §5 W2.4 (deleted), §5 P4's credential-proxy work (deleted). **Post-P3** further supersedes: §5 W3.5 (must SKIP), §5 W3.6 (skill crosses the cutover), §5 P7 (collapsed), §6 kill criterion #1 (retired). **Post-W4.0** supersedes: §5 W4.0 (DONE — see [p3-notes.md](p3-notes.md) §9 + [slack-inbound-decision.md](slack-inbound-decision.md)). **Post-W4.3** supersedes: §5 W4.3 (DONE — see [p3-notes.md](p3-notes.md) §10). **Post-W4.5** supersedes: §5 W4.5 (DONE — see [p3-notes.md](p3-notes.md) §11), new W4.5.1 added.
